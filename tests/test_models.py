...
class TestProduto:
    ...
    def test_criacao_atributos(self):
        ...
        # Novo produto
        p = Produto(id=5, nome="Camiseta Dick Vigarista & Mutle - M", preco=113.48, estoque=5)
        assert p.id      == 5
    ...
    def test_igualdade_entre_produtos(self):
        ...
        p1 = Produto(id=5, nome="Camiseta Dick Vigarista & Mutle - M", preco=113.48, estoque=5)
        p2 = Produto(id=5, nome="Camiseta Dick Vigarista & Mutle - M", preco=113.48, estoque=5)
        assert p1 == p2

    def test_produtos_com_dados_diferentes_nao_sao_iguais(self):
        
        p1 = Produto(id=1, nome="Lego", preco=480.00, estoque=5)
        p2 = Produto(id=3, nome="Mangá", preco=36.89, estoque=10)
        assert p1 != p2

    def test_repr_contem_nome(self):

        p = Produto(id=4, nome="Hisoka", preco=977.00, estoque=3)
...
class TestPedido:
    ...
    def test_pedido_sem_cupom_e_nsu(self):
        ...
        pedido = Pedido(id=None, produto_id=3, quantidade=1, valor_total=36.89)
    ...
    def test_pedido_id_igual_none(self):
        ...
        pedido = Pedido(id=None, produto_id=1, quantidade=1, valor_total=480.00)
        assert pedido.id is None

    def test_igualdade_entre_pedidos(self):
        
        p1 = Pedido(id=1, produto_id=1, quantidade=1, valor_total=480.00)
        p2 = Pedido(id=1, produto_id=1, quantidade=1, valor_total=480.00)
        assert p1 == p2
